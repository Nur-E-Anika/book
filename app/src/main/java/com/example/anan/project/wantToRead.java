...
public class wantToRead extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String>arrayAdapter = new ArrayAdapter<String>(this,
            ...
            pd = new ProgressDialog(wantToRead.this);
...
//display array list
            ...
            final String url = "https://project-22aa1.firebaseio.com/WantToRead/"+UserDetails.uid+".json";
            ...
            RequestQueue rQueue = Volley.newRequestQueue(wantToRead.this);
            rQueue.add(request);
...
//On Item click
        ...
        readBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ref.child(UserDetails.bookRef).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        UserDetails.BookName = dataSnapshot.child("genre").getValue().toString();
                        itemSel = false;
                        startActivity(new Intent(wantToRead.this,bookView.class));
                    }
       ...
       final ChildEventListener eventlist = (new ChildEventListener() {
            @Override
       ...
       ref.addChildEventListener(eventlist);
        ...
        rmvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ref.removeEventListener(eventlist);
